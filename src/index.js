...
export { default as equals } from 'src/isEqual';
...
export { default as head } from 'src/first';
export { default as id } from 'src/id';
export { default as includes } from 'src/includes';
export { default as index } from 'src/index/index';
export { default as indexOf } from 'src/index/index';
...
export { default as lower } from 'src/lower';
...
export { default as tail } from 'src/last';
...
export { default as uuid } from 'src/id';
